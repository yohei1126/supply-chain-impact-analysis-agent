...
from bom_graph.graph_viz import graph_view_for_run

from bom_graph.agent.explain import explain_results_heuristic
from bom_graph.agent.llm_client import plan_tool_calls_openai_compat, summarize_run_openai_compat
...
from bom_graph.agent.telemetry import RunTracer, start_run_tracer
...
class BomAutonomousAgent:
    """
    Autonomous agent runtime wired to Agent Skills (prompt) and bom_graph (tools).
    """
